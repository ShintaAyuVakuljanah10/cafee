        ...
        <div class="col-md-6">
            ...
            <div class="card shadow">
                ...
                <div class="card-body">
                    ...
                    <button type="button" id="btnBayar" class="btn btn-success btn-block">
                        Bayar
                    </button>
    ...
    <script>
        ...
        $('#bayar').on('keyup', function () {
            ...
            let kembali = Math.max(bayar - total, 0);
        ...
        $('#btnBayar').on('click', function () {
            ...
            $.post(`/backend/transaksi/${transaksiId}/bayar`, {
                ...
                if (res.success) {
                    ...
                    $('#print-bayar').text("Rp " + res.bayar.toLocaleString());
                    $('#print-kembali').text("Rp " + res.kembali.toLocaleString());
    ...
    <style>
        ...
        .ticket {
            ...
            padding: 15px;
            margin: 20px auto;
            /* Membuatnya di tengah secara horizontal */
