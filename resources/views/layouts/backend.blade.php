          ...
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle text-muted pr-0" href="#" id="navbarDropdownMenuLink" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              <span class="avatar avatar-sm mt-2">
                ...
                @if($user && $user->foto && file_exists(public_path('storage/'.$user->foto)))
                    <img src="{{ asset('storage/'.$user->foto) }}" alt="{{ $user->name }}" class="avatar-img rounded-circle">
                @else
                    <img src="{{ asset('tinydash/assets/avatars/face-1.jpg') }}" alt="Default" class="avatar-img rounded-circle">
                @endif
            </span>
            </a>
