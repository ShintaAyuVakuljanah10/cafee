        ...
        <ul class="nav">
          ...
          <li class="nav-item dropdown">
              ...
              <span class="avatar avatar-sm mt-2">
                ...
                @if($user && $user->foto && file_exists(public_path('storage/'.$user->foto)))
                    <img src="{{ asset('storage/'.$user->foto) }}" 
                        alt="{{ $user->name }}" 
                        class="avatar-img rounded-circle profile-pic-custom">
                @else
                    <img src="{{ asset('tinydash/assets/avatars/face-1.jpg') }}" 
                        alt="Default" 
                        class="avatar-img rounded-circle profile-pic-custom">
                @endif
            </span>
            ...
            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownMenuLink">
              <a class="dropdown-item" href="{{ route('backend.user.profile') }}">
